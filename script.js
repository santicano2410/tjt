const products = [
  ...
  {
    id: 84,
    name: 'Fuentes indoor ó pólvora fría 3 mtrs 30 seg',
    category: 'jugueteria',
    badge: 'Juguetería',
    img: 'fuentes indoor.jpeg',
    video: '',
    features: ['Efecto humo', 'Color intenso', 'Ideal para fiestas'],
  },
  {
    id: 85,
    name: 'Martillo importado Vaquero x 30 unds cja',
    category: 'jugueteria',
    badge: 'Juguetería',
    img: 'martillo importado.jpeg',
    video: '',
    features: ['Chispas brillantes', 'Uso seguro', 'Gran impacto'],
  },
  {
    id: 86,
